...
om.transit.TempIdHandler.cljs$lang$ctorPrWriter = (function (this__36436__auto__,writer__36437__auto__,opt__36438__auto__){
return cljs.core._write.call(null,writer__36437__auto__,"om.transit/TempIdHandler");
});
...
var args52467 = [];
var len__36896__auto___52470 = arguments.length;
var i__36897__auto___52471 = (0);
while(true){
if((i__36897__auto___52471 < len__36896__auto___52470)){
args52467.push((arguments[i__36897__auto___52471]));

var G__52472 = (i__36897__auto___52471 + (1));
i__36897__auto___52471 = G__52472;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args52467.length)].join('')));
...
var args52474 = [];
var len__36896__auto___52477 = arguments.length;
var i__36897__auto___52478 = (0);
while(true){
if((i__36897__auto___52478 < len__36896__auto___52477)){
args52474.push((arguments[i__36897__auto___52478]));

var G__52479 = (i__36897__auto___52478 + (1));
i__36897__auto___52478 = G__52479;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args52474.length)].join('')));
